...
- **Multiple fonts**: choose a separate font for **headings, body, lesson text and numbers**, or tap a pairing: Clean, Claude-style (Newsreader + DM Sans, open lookalikes of Claude's chat typography), Textbook, Easy reading (Lexend), Accessible (Atkinson Hyperlegible), Dyslexia-friendly (OpenDyslexic) and Chalk notes. There are 15 fonts, including Inter, IBM Plex Sans, Source Serif 4, Literata, Merriweather, Georgia, JetBrains Mono and IBM Plex Mono. Size slider 14–22 px, line height 1.4–1.9. All fonts are bundled (SIL OFL), and each one only loads when you use it.
